...
The `_total` suffix is not appended if the (translated) original metric name already ends in `_total`.
...
# HELP application_method_a_invocations_current The number of parallel invocations of visitorsTotal()
application_method_a_invocations_current 80
# TYPE application_method_a_invocations_min gauge
# HELP application_method_a_invocations_min The lowest number of parallel invocations of visitorsTotal() in the last minute
application_method_a_invocations_min 20
# TYPE application_method_a_invocations_max gauge
# HELP application_method_a_invocations_max The highest number of parallel invocations of visitorsTotal() in the last minute
